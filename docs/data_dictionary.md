...
|---|---|---|---|
| SCR.data | https://dadosabertos.bcb.gov.br/dataset/scr_data | Open Data Commons ODbL | *(Sprint 1)* |
| Selic (Ipeadata) | http://www.ipeadata.gov.br/api/odata4/ValoresSerie(SERCODIGO='BM12_TJOVER12') | *(Sprint 1)* | *(Sprint 1)* |

**Nota de proveniência:** o Ipeadata redistribui a série originalmente produzida pelo
Banco Central. Instituição mantenedora distinta, origem primária a mesma.
...
| `selic_pct` | decimal | > 0 | `VALVALOR` | Selic acumulada no mês, % ao mês |
