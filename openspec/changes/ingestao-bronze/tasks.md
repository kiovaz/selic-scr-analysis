...
- [ ] 6.3 Exportar `__init__.py` de `src/ingestion/` e `src/validation/` com os imports públicos dos módulos criados. Verificar: `from src.ingestion.scr_file_loader import carregar_scr` e `from src.validation.quality_checks import checar_uf` funcionam sem erro de import.
